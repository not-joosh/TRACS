ORG 0x00
        ...
        BRE 0x03C ; ACC = (0x3C) - (0x11) = 0x2B ZF=0, CF=0, OF=0, SF=0         ; 0x38, 0x39
        WB 0x2E ; MBR = 0x2E                                                    ; 0x3A, 0x3B
        BRGT 0x042 ; ACC = (0x2B) - (0x2E) = 0xFD ZF=0, CF=0, OF=0, SF=1        ; 0x3C, 0x3D
        AND ; ACC = (0xFD) AND (0x2E) = 0x2C ZF=0, CF=0, OF=0, SF=0             ; 0x3E, 0x3F
        BRLT 0x046      ; ACC = (0x2C) - (0x2E) = 0xFE ZF=0, CF=0, OF=0, SF=1   ; 0x40, 0x41
        WB 0x00         ; unreachable                                           ; 0x42, 0x43
        WACC            ; unreachable                                           ; 0x44, 0x45
        WB 0x03         ; MBR = 0x03                                            ; 0x46, 0x47
